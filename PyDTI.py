...
def main(argv):
    try:
        opts, args = getopt.getopt(argv, "m:d:f:c:s:o:n:p:C", ["method=", "dataset=", "data-dir=", "cvs=", "specify-arg=", "method-options=", "predict-num=", "output-dir=", "cv_type="])
    ...
    if method == 'nnkronsvm':
        args = {'NbNeg': 10, 'PosNei': 10, 'NegNei': 1, }
    ...
    if predict_num == 0:
        ...
        cv_data = cross_validation(X, seeds, cv, cv_type=cv_type)
